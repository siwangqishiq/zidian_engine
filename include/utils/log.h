...
namespace zidian {
    ...
    public:
        ...
        const static std::string DEFAULT_LOG_FILE_PATH;
    ...
    private:
        ...
        static void write(const std::string& level, const std::string& tag,const std::string& msg,const char* color);

        static void writeToFile(const std::string& level,const std::string& tag,const std::string& msg);
    };//end class Log
}
